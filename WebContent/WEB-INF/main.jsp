...
<head>
	...
	<script src="${path}/resources/js/cnDateFn.js" type="text/javascript">
		    ...
		    <div class="main-wrap cf">
		      ...
		      <ul class="quick-links">
		        ...
		        <li class="statistics-funds">
		        	<a data-tabid="" data-tabTxt="资产购置" data-parentOpen="true" rel="pageTab" href="${path}/contract/subAdd?moduleType=2">
		        		<span></span>资产购置
		        	</a>
		        </li>
		        ...
		        <li class="feedback">
		        	<a data-tabid="" data-tabTxt="资产调拨" data-parentOpen="true" rel="pageTab" href="${path}/assetmanage/assetchange/toList"><span></span>资产调拨</a>
		        </li>
		      </ul>
		    </div>
		</div>
		<div class="col-extra">
		  <div class="extra-wrap">
		    ...
		    <div class="list">
		      <ul>
		      	<li>
		      		<a href="${path}/report/contractCountByModule" rel="pageTab" data-tabid="httj" data-tabTxt="查看统计" data-parentOpen="true">查看统计</a>
		      	</li>
		        <li>
