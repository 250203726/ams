    ...
    <script type="text/javascript">
		...
		$(document).ready(function(){
			grid = $("#maingrid").ligerGrid({
				columns: [
				{ display: '资产名称编号', name: 'assetnameId', width: "250" },
				{ display: '资产名称', name: 'assetName', width: "100" },
				{ display: '资产类别', name: 'assetType', width: "100" },
				checkbox:true,
				usePager:true,
				delayLoad:true,//延迟加载
				root:'rows',
				record:'total',
	            url:"${path}/assetmanage/assetnam/popList",
				fixedCellHeight: false,
				rownumbers:true,
				clickToEdit:false,
				width: '100%',height:'98%',
				isChecked:function(rowdata){
					if (rowdata.assetnameId=='${model.assetnameId}') 
		                return true;
		            return false;
				},
		...
		function search(){
			...
			grid.set("url","${path}/assetmanage/assetnam/popList?"+params);
			grid.reload();
			return false;
		}
		function f_select()
