...
import com.util.tools.ToolRandoms;
 ...
 * 验证码
 * @author Wymann
 * @Data 2014-12-6 下午01:21:52
 *
 */
@Controller
public class AuthImgAction extends BaseAction{

	private static final long serialVersionUID = -433668135324278790L;
	...
	static {
		...
		Font font01 = new Font("Terminal", Font.PLAIN, FONTSIZE);
		fontList.add(font01);

		Font font02 = new Font("Times New Roman", Font.PLAIN, FONTSIZE);
		fontList.add(font02);

		Font font03 = new Font("Trebuchet MS", Font.PLAIN, FONTSIZE);
		fontList.add(font03);

		Font font04 = new Font("System", Font.PLAIN, FONTSIZE);
		fontList.add(font04);

		Font font05 = new Font("Stencil", Font.PLAIN, FONTSIZE);
		fontList.add(font05);

		Font font06 = new Font("Segoe Print", Font.PLAIN, FONTSIZE);
		fontList.add(font06);

		Font font07 = new Font("Palatino Linotype", Font.PLAIN, FONTSIZE);
		fontList.add(font07);

		Font font08 = new Font("Lucida Sans", Font.PLAIN, FONTSIZE);
		fontList.add(font08);

		Font font09 = new Font("Franklin Gothic", Font.PLAIN, FONTSIZE);
		fontList.add(font09);

		Font font10 = new Font("Felix Titling", Font.PLAIN, FONTSIZE);
		fontList.add(font10);
	}
	...
	public void index(HttpServletResponse response) {
		...
		// 设置验证码值到cookie
		setAuthCode(response, sRand.toLowerCase());
	...
	public static void setAuthCode(HttpServletResponse response, String authCode){
		...
		// 登陆认证cookie
		int maxAgeTemp = BaseConst.maxAge;
		ToolWeb.addCookie(response,  "", "/", true, BaseConst.authcode, securityCookie, maxAgeTemp);
	}
	...
	private String graphics(BufferedImage bufferedImage) {
		...
		for (int i = 0; i < 4; i++) {
			...
			// 在图片上绘制系统生成的随机字符
			graphics.drawString(String.valueOf(tmp), 20 * i + 20, 20);
		}
