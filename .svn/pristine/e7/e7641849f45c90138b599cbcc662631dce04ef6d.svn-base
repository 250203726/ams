...
CREATE TABLE `t_assetinfo` (
  ...
  `assettypeId` varchar(32) DEFAULT NULL COMMENT '资产类型编号',
  ...
  KEY `FK_ASSETTYPEID` (`assettypeId`),
  CONSTRAINT `FK_ASSETTYPEID` FOREIGN KEY (`assettypeId`) REFERENCES `t_assettype` (`assettypeId`),
...
INSERT INTO `t_assetinfo` VALUES ('LWSF2015SS002', '1423424323434', '71434SE-06CN951', '0', 'IBM', 'X3850 X5', null, '', '在用', '肖珍军', '12', '李文虎', '2016-09-10 08:47:41', '2020-09-10 08:47:41', '2025-09-10 08:47:48', '1482138082920790', '14829705646892568', '14821931073053551', '14821381788966829', '数据中心机房一区2-09机柜27-30U', '2020-12-26 00:00:00', '2025-12-26 00:00:00', '');
...
CREATE TABLE `t_assetpurchaseapplication` (
  `purchaseapplicationId` varchar(32) NOT NULL COMMENT '资产购置编号',
  `userId` varchar(32) DEFAULT NULL COMMENT '用户编号',
  `purchaseDepartment` varchar(50) DEFAULT NULL COMMENT '购置部门',
  `Applicant` varchar(50) DEFAULT NULL COMMENT '申请人编号',
  `applicationTime` datetime DEFAULT NULL COMMENT '申请时间',
  `assettypeId` varchar(32) DEFAULT NULL COMMENT '资产类型编号',
  `specificationModel` varchar(50) DEFAULT NULL COMMENT '规格型号',
  `purchaseQuantity` int(11) DEFAULT NULL COMMENT '购买数量',
  `budgetFunds` float DEFAULT NULL COMMENT '预算资金',
  `purchaseReason` varchar(100) DEFAULT NULL COMMENT '请购理由及用途',
  `remark` varchar(100) DEFAULT NULL COMMENT '备注',
  `approveOpinion` varchar(100) DEFAULT NULL COMMENT '审批意见',
  `Approver` varchar(20) DEFAULT NULL COMMENT '审批人',
  PRIMARY KEY (`purchaseapplicationId`),
  KEY `FK_Reference_11` (`userId`),
  KEY `FK_Reference_14` (`assettypeId`),
  CONSTRAINT `FK_Reference_11` FOREIGN KEY (`userId`) REFERENCES `t_user` (`user_Id`),
  CONSTRAINT `FK_Reference_14` FOREIGN KEY (`assettypeId`) REFERENCES `t_assettype` (`assettypeId`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='资产购置申请';

-- ----------------------------
-- Records of t_assetpurchaseapplication
-- ----------------------------
INSERT INTO `t_assetpurchaseapplication` VALUES ('14827138618723091', null, '网络事业科', '', '2016-12-26 08:56:26', '14821385520753843', 'CE12808s', '1', '180000', '网络规划', '1', '', '');
INSERT INTO `t_assetpurchaseapplication` VALUES ('14830647956421934', '01', '通信管理科', '', '2016-12-30 10:25:30', '14827436955321203', 'BR6510', '1', '80000', '云数据中心', '', '通过', '');
...
CREATE TABLE `t_assettype` (
  ...
  CONSTRAINT `FK_UNITID` FOREIGN KEY (`unitId`) REFERENCES `t_unit` (`unitId`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='资产类型';

-- ----------------------------
-- Records of t_assettype
-- ----------------------------
INSERT INTO `t_assettype` VALUES ('1423424323434', 'EMC扩展柜', '04');
INSERT INTO `t_assettype` VALUES ('14821384404846037', '机架式服务器', '01');
INSERT INTO `t_assettype` VALUES ('14821385065523126', '主交换路由设备', '01');
INSERT INTO `t_assettype` VALUES ('14821385174103575', '入侵检测', '01');
INSERT INTO `t_assettype` VALUES ('14821385271617048', '防火墙', '01');
INSERT INTO `t_assettype` VALUES ('14821385416547831', '安全网关', '01');
INSERT INTO `t_assettype` VALUES ('14821385520753843', '核心交换机', '01');
INSERT INTO `t_assettype` VALUES ('14824534278225704', '精密空调', '02');
INSERT INTO `t_assettype` VALUES ('14824540373435537', '数据库服务器', '04');
INSERT INTO `t_assettype` VALUES ('14824540542879543', '大数据分析服务器', '04');
INSERT INTO `t_assettype` VALUES ('14827435168793279', '电话网关', '01');
INSERT INTO `t_assettype` VALUES ('14827435358515526', '加密工控机', '01');
INSERT INTO `t_assettype` VALUES ('14827435410646045', '加密机', '02');
INSERT INTO `t_assettype` VALUES ('14827435731095464', '机架式存储', '01');
INSERT INTO `t_assettype` VALUES ('14827435798184183', 'EMC扩展柜', '02');
INSERT INTO `t_assettype` VALUES ('14827436955321203', '光纤交换机', '01');
INSERT INTO `t_assettype` VALUES ('14827437435363644', '大数据系统服务器', '04');
INSERT INTO `t_assettype` VALUES ('14827437588091696', '虚拟化资源服务器', '04');
INSERT INTO `t_assettype` VALUES ('14827437767362889', '接入交换机', '04');
INSERT INTO `t_assettype` VALUES ('14827437970333759', '虚拟磁带库', '04');
INSERT INTO `t_assettype` VALUES ('14828027284769466', 'UPS', '01');
...
CREATE TABLE `t_code` (
  ...
  PRIMARY KEY (`codeId`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='合同简码,无用\r\n';
...
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='施工单位，模板';
...
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='客户表,模板';
...
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='厂商';
...
INSERT INTO `t_login_log` VALUES ('14842764969781625', 'admin', '2017-01-13 11:01:36', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14842765269206460', 'admin', '2017-01-13 11:02:06', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('1484294807561117', 'admin', '2017-01-13 16:06:47', 'fe80:0:0:0:cc07:e357:4219:73f2%13', '登录成功');
INSERT INTO `t_login_log` VALUES ('14843653574738037', 'admin', '2017-01-14 11:42:37', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846385333169565', 'admin', '2017-01-17 15:35:33', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846388716313808', 'admin', '2017-01-17 15:41:11', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846389221168763', 'admin', '2017-01-17 15:42:02', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846392626532930', 'admin', '2017-01-17 15:47:42', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('1484639303473934', 'admin', '2017-01-17 15:48:23', 'fe80:0:0:0:cc07:e357:4219:73f2%13', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846394399782051', 'admin', '2017-01-17 15:50:39', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846396842998493', 'admin', '2017-01-17 15:54:44', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846435939148551', 'admin', '2017-01-17 16:59:53', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846439417903034', 'admin', '2017-01-17 17:05:41', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846441191011824', 'admin', '2017-01-17 17:08:39', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('1484644172788431', 'admin', '2017-01-17 17:09:32', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846496600844632', 'admin', '2017-01-17 18:41:00', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846499146634494', 'admin', '2017-01-17 18:45:14', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846505037786369', 'admin', '2017-01-17 18:55:03', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846506156404363', 'admin', '2017-01-17 18:56:55', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('1484650953963687', 'admin', '2017-01-17 19:02:33', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846512331628785', 'admin', '2017-01-17 19:07:13', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846514440694208', 'admin', '2017-01-17 19:10:44', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846525366345422', 'admin', '2017-01-17 19:28:56', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14846531118207617', 'admin', '2017-01-17 19:38:31', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('1484654679235246', 'admin', '2017-01-17 20:04:39', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14847050003735239', 'admin', '2017-01-18 10:03:20', '192.168.253.1', '登录成功');
INSERT INTO `t_login_log` VALUES ('14847093000613210', 'admin', '2017-01-18 11:15:00', 'fe80:0:0:0:cc07:e357:4219:73f2%13', '登录成功');
INSERT INTO `t_login_log` VALUES ('14847107242559493', 'admin', '2017-01-18 11:38:44', 'fe80:0:0:0:cc07:e357:4219:73f2%13', '登录成功');
INSERT INTO `t_login_log` VALUES ('14847126378332995', 'admin', '2017-01-18 12:10:37', '172.25.5.128', '登录成功');
INSERT INTO `t_login_log` VALUES ('1484713305807073', 'admin', '2017-01-18 12:21:45', '172.25.5.128', '登录成功');
INSERT INTO `t_login_log` VALUES ('14847189782208948', 'admin', '2017-01-18 13:56:18', 'fe80:0:0:0:cc07:e357:4219:73f2%13', '登录成功');
INSERT INTO `t_login_log` VALUES ('1484723860698568', 'admin', '2017-01-18 15:17:40', 'fe80:0:0:0:cc07:e357:4219:73f2%13', '登录成功');
INSERT INTO `t_login_log` VALUES ('14847241200252461', 'admin', '2017-01-18 15:22:00', '172.25.5.222', '登录成功');
INSERT INTO `t_login_log` VALUES ('14847246984228852', 'admin', '2017-01-18 15:31:38', '172.25.5.222', '登录成功');
INSERT INTO `t_login_log` VALUES ('14847254001569711', 'admin', '2017-01-18 15:43:20', '172.25.5.222', '登录成功');
...
CREATE TABLE `t_maintenanceinfo` (
  `maintenanceId` varchar(32) NOT NULL COMMENT '维护公司编号',
  `maintenanceName` varchar(100) DEFAULT NULL COMMENT '维护公司名称',
  `maintenanceContacts` varchar(100) DEFAULT NULL COMMENT '维护公司联系人',
  `maintenancecontactsPhone` varchar(11) DEFAULT NULL COMMENT '维护公司联系人电话',
...
CREATE TABLE `t_maintenancerecord` (
  `maintenancerecordId` varchar(32) NOT NULL COMMENT '维护记录编号',
  `assetId` varchar(32) DEFAULT NULL COMMENT '资产编号',
  `recordPeople` varchar(50) DEFAULT NULL COMMENT '检修成员',
  `recordInfo` varchar(200) DEFAULT NULL COMMENT '检修性质',
  `repairTime` datetime DEFAULT NULL COMMENT '检修日期',
  `repairExstatus` varchar(200) DEFAULT NULL COMMENT '检修前状态',
  `repairContent` varchar(200) DEFAULT NULL COMMENT '检修内容',
  `repairAftstatus` varchar(200) DEFAULT NULL COMMENT '检修后状态',
  `acceptancePerson` varchar(50) DEFAULT NULL COMMENT '验收人',
  `recordTime` datetime DEFAULT NULL COMMENT '记录时间',
  `AcceptanceEvaluation` varchar(200) DEFAULT NULL COMMENT '验收评价',
...
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='项目经理,，模板';
...
INSERT INTO `t_menu` VALUES ('14772852690089630', '4', '1420711336094951', '部门', '', '', null, '', '2', '3', 'basic', '1');
...
INSERT INTO `t_menu` VALUES ('14800420921314586', '6', '1420711336094951', '单位', '', '', null, '', '2', '2', 'basic', '1');
INSERT INTO `t_menu` VALUES ('14800422049112745', '5', '14800420921314586', '单位录入', '', '/infomanage/unit/add', null, '', '3', '1', 'basic', '1');
INSERT INTO `t_menu` VALUES ('14800422713788163', '4', '14800420921314586', '单位列表', '', '/infomanage/unit/toList', null, '', '3', '2', 'basic', '1');
INSERT INTO `t_menu` VALUES ('14804871453306101', '0', '14772852690089630', '部门组织结构', '', '', null, '', '3', '3', 'basic', '1');
INSERT INTO `t_menu` VALUES ('14808271283548721', '3', '14772852154601912', '资产类型录入', '', '/assetmanage/assettype/add', null, '', '3', '3', 'asset', '1');
INSERT INTO `t_menu` VALUES ('14808272251136452', '3', '14772852154601912', '资产类型列表', '', '/assetmanage/assettype/toList', null, '', '3', '4', 'asset', '1');
...
CREATE TABLE `t_project` (
  ...
  `projectHead` varchar(50) DEFAULT NULL COMMENT '项目负责人',
...
CREATE TABLE `t_unit` (
  `unitId` varchar(32) NOT NULL COMMENT '单位编号',
...
-- Records of t_unit
-- ----------------------------
INSERT INTO `t_unit` VALUES ('01', '湖北省交通运输厅通信信息中心');
INSERT INTO `t_unit` VALUES ('02', '湖北省交通科学研究所');
INSERT INTO `t_unit` VALUES ('04', '运管局');
