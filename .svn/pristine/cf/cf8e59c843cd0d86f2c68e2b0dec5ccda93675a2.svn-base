...
(function ($)
{
    ...
    $.ligerui.controls.DateEditor.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            dateeditorHTML += "                <tr><th align='center'></th><th align='center'></th><th align='center'></th><th align='center'></th><th align='center'></th><th align='center'></th><th align='center'></th></tr>";
            dateeditorHTML += "            </thead>";
            ...
            *************/
            ...
            g.buttons.btnYear.click(function ()
            {
                ...
                if (!g.body.yearselector.is(":visible"))
                {
                    ...
                    {
                        var currentYear = g.currentDate.year + (i - 5);
