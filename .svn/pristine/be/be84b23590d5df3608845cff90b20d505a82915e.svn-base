...
(function($) {
    ...
    $.ligerui.controls.Accordion.ligerExtend($.ligerui.core.UIComponent, {
        ...
        setHeight: function(height) {
            ...
            $("> .l-accordion-content", g.accordion).height(height-18); // (border-top(3px) + border-bottom(3px)） *3
        }
    });
...
(function($) {
    ...
    $.ligerui.controls.DateEditor.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function() {
            ...
            dateeditorHTML += "        <ul class='l-box-dateeditor-yearselector'><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul>";
            ...
            g.buttons.btnYear.click(function() {
                ...
                if (!g.body.yearselector.is(":visible")) {
                    $("li", g.body.yearselector).each(function(i, item) {
                        var currentYear = g.currentDate.year + (i - 10);
...
(function($) {
    ...
    //dialog 图片文件夹的路径 预加载
    $.ligerui.DialogImagePath = "../../lib/ligerUI/skins/Gray/images/win/";
...
(function($) {
    ...
    $.ligerDefaults.GridString = {
        errorMessage: '发生错误',
        pageStatMessage: '显示第{from}条到{to}，一共 {total} 条 ',
